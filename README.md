...
**Sistema 1 — Suite Pulsímetro:** pipeline Python de 3 fases que integra fuentes de datos del INE y Ministerio de Transportes, actualiza 9 variables × 51 provincias y genera 61 PDFs corporativos. De horas de trabajo manual a ~5 minutos.  
**Sistema 2 — Formularios MBA:** 11 flujos n8n que crean automáticamente Google Forms desde un Excel de control, con deduplicación y gestión de estado. Cubre todos los programas presenciales y online.

**Stack:** Python · openpyxl · reportlab · pypdf · n8n · Google Forms API · Google Sheets API
